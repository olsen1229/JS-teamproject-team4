        ...
        return `
                <a class="card" >
                        ...
                        <div class="event-info"><p class="date">${dates.start.localDate}</p>
                          <p class="location">
                              <img src="/JS-teamproject-team4/location-icon.bb39e645.png" alt="location icon" class="location-icon">
                              ${venues[0].name}
                          </p></div>
                    </a>
                `;
                      ...
                      <div class="ticket-info">
                          <div class="ticket-info-item">
                              ...
                              <div class="ticket-prices">
                                  <img src="/JS-teamproject-team4/ticket.4ca21708.png" alt="ticket barcode" class="barcode-image">
